...
def build_judge_system_prompt() -> str:
    ...
    return (
        ...
        "applicable to false and score to null, but still include confidence (use 1.0) and a "
        "short rationale such as 'Not applicable for this question type'. "
        "Every dimension must include: dimension, score, applicable, confidence, rationale, "
        "and issues (possibly empty). Give concise rationales and concise issue lists. "
