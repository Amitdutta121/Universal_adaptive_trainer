...
class GenerationService:
    ...
    def generate_for_sections(
        ...
        *,
        ...
        generation when a later selected id is invalid. The topic and subtopics
        each question carries come back from the generator, not from this call.
        """
        ...
        for spec in specs:
            row = self._questions.add(
                self._row_from_question(active.generate_one(spec, version=version))
            )
